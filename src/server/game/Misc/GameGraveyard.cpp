...
GraveyardStruct const* Graveyard::GetClosestGraveyard(Player* player, TeamId teamId, bool nearCorpse)
{
    ...
    // mod_playerbots: Bots brauchen die Suche ohne Player-Objekt. Die CoA-taugliche
    // Klassenpruefung bleibt hier, damit sie im Koordinatenpfad nicht verlorengeht.
