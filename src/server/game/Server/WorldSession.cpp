...
void WorldSession::LogoutPlayer(bool save, bool redirecting)
{
    ...
    if (_player)
    {
        ...
        // mod_playerbots: Bots melden sich je Charakter ab, nicht je Konto
...
// mod_playerbots: Der Prototyp stand im Header ohne Definition. Bots reichen ihre
// erzeugten Pakete ueber diese Warteschlange in die eigene Sitzung ein.
