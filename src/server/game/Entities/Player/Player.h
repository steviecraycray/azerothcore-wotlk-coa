...
public:
    ...
    // mod_playerbots: wie CanUseItem, aber mit Relikt-Pruefung fuer die Ausruestungsbewertung
    ...
    // mod_playerbots: Bots pruefen, ob sie einen Kanal schon abonniert haben
