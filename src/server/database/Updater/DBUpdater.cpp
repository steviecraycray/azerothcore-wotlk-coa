...
{
    return GetSourceDirectory() + "/data/sql/base/db_auth/";
}
...
{
    return GetSourceDirectory() + "/data/sql/base/db_world/";
}
...
{
    return GetSourceDirectory() + "/data/sql/base/db_characters/";
}
...
{
    return GetSourceDirectory() + "/data/sql/playerbots/base/";
}
