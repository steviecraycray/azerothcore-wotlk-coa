...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_MANASTORM_CLEARS,
    CHAR_INS_MANASTORM_CLEAR,
    CHAR_DEL_MANASTORM_CLEARS,
    CHAR_SEL_MANASTORM_BONUS,
    CHAR_REP_MANASTORM_BONUS,
    CHAR_DEL_MANASTORM_BONUS,
    CHAR_SEL_MANASTORM_LOADOUT,
    CHAR_REP_MANASTORM_LOADOUT,
    CHAR_DEL_MANASTORM_LOADOUT,
    CHAR_SEL_MANASTORM_XP,
    CHAR_ADD_MANASTORM_XP,
    CHAR_CLAIM_MANASTORM_XP,
    CHAR_DEL_MANASTORM_XP,
    CHAR_SEL_MANASTORM_CACHES,
    CHAR_INS_MANASTORM_CACHE,
    CHAR_DEL_MANASTORM_CACHE,
    CHAR_DEL_MANASTORM_CACHES,
    CHAR_DEL_MANASTORM_CACHE_ITEMS,
    CHAR_INS_MANASTORM_CACHE_INVENTORY,
    CHAR_SEL_MANASTORM_INVENTORY_ITEM,

    CHAR_INS_PLAYER_ANTICHEAT_ALERT,
